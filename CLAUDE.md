...
Engines: Node ≥ 20, pnpm ≥ 9. The committed package manager is pnpm@12.4.1. Releases use changesets; the `main` branch publishes to npm via `.github/workflows/publish-packages.yml`.
