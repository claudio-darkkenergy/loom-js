...
// Local copy of the retired @loom-js/tags helper — this component is its one
// remaining consumer (core is not gaining a props-to-attrs util that element
// syntax exists to obsolete).
