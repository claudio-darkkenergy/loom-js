# content-delivery-performance Specification (delta)
...
- **THEN** exactly one POST to `/api/contentful/graphql` is issued, and both the side nav and the topic body render from its response
